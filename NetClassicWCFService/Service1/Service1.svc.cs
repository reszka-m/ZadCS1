...
namespace Service1
{
    ...
    public class Service1 : IService1
    {
        ...
        public List<string> zwrocZadania()
        {
            List<string> zadania = new List<string>()
        {
            "Zadanie 1 - Przygotować projekt na przedmiot",
            "Zadanie 2 - Zdefinuj własny webserwis WCF jako witrynę aplikacyjną (svc) w architekturze SOAP ",
            "Zadnie 3 - jakies zadanie"
        };
